        ...
        <div class="flex flex-row items-center gap-5 w-full">
          ...
          <div class="flex flex-col">
              ...
              {#each socialLinks as social}
                ...
                >
                  <svelte:component
                    this={social.icon}
                    size={20}
                    class="text-gray-200 hover:text-(--ui-primary) transition-all duration-300"
                  />
                </a>
              {/each}
            </div>
            <p class="text-gray-300 text-sm mb-1 font-outfit relative">
              <span
                class="rounded-full w-2 h-2 bg-green-400 inline-block absolute top-[6px] animate-ping"
              ></span>
              <span class="rounded-full w-2 h-2 bg-green-400 inline-block relative -top-[1px] mr-1"
              ></span>
              Available for work
            </p>
          </div>
